...
export_macro_mk CONFIG_HSA_AMD_P2P_AMDKCL ${_enable}
...
export_macro_mk CONFIG_HSA_AMD_SVM_AMDKCL ${_enable}

export_macro_mk CONFIG_HSA_AMD_AMDKCL
export_macro_mk CONFIG_DRM_AMDGPU_CIK_AMDKCL
export_macro_mk CONFIG_DRM_AMDGPU_SI_AMDKCL
export_macro_mk CONFIG_DRM_AMDGPU_USERPTR_AMDKCL
export_macro_mk CONFIG_DRM_AMD_DC_AMDKCL
