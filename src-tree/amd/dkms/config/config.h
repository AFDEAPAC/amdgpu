...
/* #undef HAVE_ACPI_VIDEO_BACKLIGHT_USE_NATIVE */
...
/* #undef HAVE_APERTURE_REMOVE_CONFLICTING_PCI_DEVICES */

/* apple_gmux_detect() is available */
/* #undef HAVE_APPLE_GMUX_DETECT */
...
/* #undef HAVE_ASSIGN_STR_ONE_ARGUMENT */
...
/* #undef HAVE_CPUINFO_TOPOLOGY_IN_CPUINFO_X86_STRUCT */

/* drm_edid_raw() is available */
/* #undef HAVE_CRTC_DRM_VBLANK_CRTC */
...
/* #undef HAVE_DMA_FENCE_ARRAY_FIRST */

/* dma_fence_chain_alloc() is available */
/* #undef HAVE_DMA_FENCE_CHAIN_ALLOC */

/* dma_fence_chain_contained() is available */
/* #undef HAVE_DMA_FENCE_CHAIN_CONTAINED */

/* dma_fence_dedup_array() is available */
/* #undef HAVE_DMA_FENCE_DEDUP_ARRAY */

/* dma_fence_describe() is available */
/* #undef HAVE_DMA_FENCE_DESCRIBE */

/* dma_fence_is_container() is available */
/* #undef HAVE_DMA_FENCE_IS_CONTAINER */

/* dma_fence_is_later_or_same() is available */
/* #undef HAVE_DMA_FENCE_IS_LATER_OR_SAME */

/* struct dma_fence_ops has callback set_deadline */
/* #undef HAVE_DMA_FENCE_OPS_SET_DEADLINE */
...
#define HAVE_DRM_ADD_OVERRIDE_EDID_MODES 1
...
/* #undef HAVE_DRM_ATOMIC_PLANE_ENABLING */
...
/* #undef HAVE_DRM_CONNECTOR_DYNAMIC_INIT */

/* drm_connector->edid_override is available */
/* #undef HAVE_DRM_CONNECTOR_EDID_OVERRIDE */

/* drm_connector->eld_mutex is available */
/* #undef HAVE_DRM_CONNECTOR_ELD_MUTEX */
...
/* atomic_best_encoder take 2nd arg type of state as struct drm_atomic_state
   */
/* #undef HAVE_DRM_CONNECTOR_HELPER_FUNCS_ATOMIC_BEST_ENCODER_ARG_DRM_ATOMIC_STATE */
...
/* #undef HAVE_DRM_CONNECTOR_STATE_HDMI_BROADCAST_RGB */
...
/* #undef HAVE_DRM_CONNECT_ATTACH_COLORSPACE_PROPERTY */

/* drm_crtc_helper_funcs->atomic_check()/atomic_flush()/atomic_begin() wants
   struct drm_atomic_state arg */
/* #undef HAVE_DRM_CRTC_HELPER_FUNCS_ATOMIC_CHECK_ARG_DRM_ATOMIC_STATE */

/* drm_crtc_helper_funcs->atomic_enable()/atomic_disable() wants struct
   drm_atomic_state arg */
/* #undef HAVE_DRM_CRTC_HELPER_FUNCS_ATOMIC_ENABLE_ARG_DRM_ATOMIC_STATE */

/* drm_crtc_helper_mode_valid_fixed() is available */
/* #undef HAVE_DRM_CRTC_HELPER_MODE_VALID_FIXED */

/* drm_dbg_printer() is available */
/* #undef HAVE_DRM_DBG_PRINTER */
...
/* #undef HAVE_DRM_DISPLAY_INFO_SOURCE_PHYSICAL_ADDRESS */
...
/* drm_dp_atomic_release_vcpi_slots() with drm_dp_mst_port argument is
   available */
#define HAVE_DRM_DP_ATOMIC_RELEASE_VCPI_SLOTS_MST_PORT 1
...
#define HAVE_DRM_DP_MST_ATOMIC_ENABLE_DSC_WITH_5_ARGS 1

/* the guid of struct drm_dp_mst_branch is guid_t */
/* #undef HAVE_DRM_DP_MST_BRANCH_GUID_T */
...
/* #undef HAVE_DRM_DP_MST_EDID_READ */
...
/* #undef HAVE_DRM_DP_MST_HPD_IRQ_HANDLE_EVENT */
...
/* #undef HAVE_DRM_DP_MST_TOPOLOGY_QUEUE_PROBE */

/* struct drm_dp_mst_topology_state has member payloads */
/* #undef HAVE_DRM_DP_MST_TOPOLOGY_STATE_PAYLOADS */
...
/* #undef HAVE_DRM_DRM_CLIENT_EVENT_H */
...
/* #undef HAVE_DRM_DRM_FBDEV_TTM_H */

/* Define to 1 if you have the <drm/drm_gem_atomic_helper.h> header file. */
/* #undef HAVE_DRM_DRM_GEM_ATOMIC_HELPER_H */
...
/* #undef HAVE_DRM_EDID_MALLOC */

/* drm_edid_override_connector_update() is available */
/* #undef HAVE_DRM_EDID_OVERRIDE_CONNECTOR_UPDATE */

/* drm_edid_raw() is available */
/* #undef HAVE_DRM_EDID_RAW */

/* drm_edid_valid() is available */
/* #undef HAVE_DRM_EDID_VALID */
...
/* #undef HAVE_DRM_FILE_CLIENT_NAME */

/* drm_file_err() is available */
/* #undef HAVE_DRM_FILE_ERR */

/* drm_firmware_drivers_only() is available */
/* #undef HAVE_DRM_FIRMWARE_DRIVERS_ONLY */
...
/* #undef HAVE_DRM_GEM_OBJECT_FUNCS_VMAP_2ARGS */

/* drm_gem_object_funcs.vmap hsa iosys_map arg */
/* #undef HAVE_DRM_GEM_OBJECT_FUNCS_VMAP_HAS_IOSYS_MAP_ARG */

/* drm_gem_object_is_shared_for_memory_stats() is available */
/* #undef HAVE_DRM_GEM_OBJECT_IS_SHARED_FOR_MEMORY_STATS */
...
/* #undef HAVE_DRM_GEM_PLANE_HELPER_PREPARE_FB */

/* drm_gem_prime_handle_to_dmabuf() is available */
/* #undef HAVE_DRM_GEM_PRIME_HANDLE_TO_DMABUF */
...
/* #undef HAVE_DRM_GET_PANEL_MIN_BRIGHTNESS_QUIRK */
...
/* #undef HAVE_DRM_KMS_HELPER_CONNECTOR_HOTPLUG_EVENT */
...
/* #undef HAVE_DRM_MEMCPY_FROM_WC_IOSYS_MAP_ARG */

/* drm_memory_stats_is_zero() is available */
/* #undef HAVE_DRM_MEMORY_STATS_IS_ZERO */
...
#define HAVE_DRM_MODE_CONFIG_FB_BASE 1

/* drm_mode_config->fb_modifiers_not_supported is available */
/* #undef HAVE_DRM_MODE_CONFIG_FB_MODIFIERS_NOT_SUPPORTED */

/* drm_mode_create_dp_colorspace_property() has 2 args */
/* #undef HAVE_DRM_MODE_CREATE_DP_COLORSPACE_PROPERTY_2ARGS */

/* drm_mode_create_hdmi_colorspace_property() has 2 args */
/* #undef HAVE_DRM_MODE_CREATE_HDMI_COLORSPACE_PROPERTY_2ARGS */

/* drm_mode_init() is available */
/* #undef HAVE_DRM_MODE_INIT */
...
/* #undef HAVE_DRM_PRIME_SG_TO_DMA_ADDR_ARRAY */
...
/* #undef HAVE_DRM_PRINT_MEMORY_STATS */
...
/* #undef HAVE_DRM_SUBALLOC_MANAGER_INIT */
...
#define HAVE_DRM_VMA_OFFSET_NODE_READONLY_FIELD 1

/* drm_writeback_connector_init() has 7 args */
/* #undef HAVE_DRM_WRITEBACK_CONNECTOR_INIT_7_ARGS */
...
/* #undef HAVE_GENERIC_HANDLE_DOMAIN_IRQ */
...
/* #undef HAVE_GET_USER_PAGES_REMOTE_REMOVE_VMAS */

/* get_user_pages() remove vmas argument */
/* #undef HAVE_GET_USER_PAGES_REMOVE_VMAS */
...
/* #undef HAVE_IO_MAPPING_MAP_LOCAL_WC */

/* io_mapping_unmap_local() is available */
/* #undef HAVE_IO_MAPPING_UNMAP_LOCAL */

/* is_cow_mapping() is available */
/* #undef HAVE_IS_COW_MAPPING */
...
/* #undef HAVE_LINUX_CGROUP_DMEM_H */

/* Define to 1 if you have the <linux/cleanup.h> header file. */
/* #undef HAVE_LINUX_CLEANUP_H */
...
/* #undef HAVE_LINUX_CONTAINER_OF_H */
...
/* #undef HAVE_LINUX_DMA_FENCE_UNWRAP_H */
...
/* #undef HAVE_MIGRATE_VMA_FAULT_PAGE */
...
#define HAVE_NO_KVREALLOC 1

/* class_create has one argument */
/* #undef HAVE_ONE_ARGUMENT_OF_CLASS_CREATE */
...
/* #undef HAVE_PM_RUNTIME_GET_IF_ACTIVE_1ARGS */

/* pm_runtime_get_if_active() has two parameters */
#define HAVE_PM_RUNTIME_GET_IF_ACTIVE_2ARGS 1
...
#define HAVE_REMOVE_CONFLICTING_PCI_FRAMEBUFFERS_PP 1
...
/* #undef HAVE_SG_ALLOC_TABLE_FROM_PAGES_SEGMENT */

/* shmem_read_folio() is available */
/* #undef HAVE_SHMEM_READ_FOLIO */
...
/* #undef HAVE_SMCA_GET_BANK_TYPE_WITH_TWO_ARGUMENTS */

/* enum SMCA_UMC_V2 is available */
/* #undef HAVE_SMCA_UMC_V2 */

/* strscpy() allows two arguments */
/* #undef HAVE_STRSCPY_ALLOW_TWO_ARGUMENTS */
...
/* #undef HAVE_STRUCT_DRM_CRTC_FUNCS_GAMMA_SET_OPTIONAL */
...
#define HAVE_STRUCT_DRM_DRV_GEM_OPEN_OBJECT_CALLBACK 1
...
/* #undef HAVE_STRUCT_DRM_PLANE_HELPER_FUNCS_GET_SCANOUT_BUFFER */

/* ide->idr_base is available */
#define HAVE_STRUCT_IDE_IDR_BASE 1

/* struct smca_bank is available */
#define HAVE_STRUCT_SMCA_BANK 1
...
/* #undef HAVE_STR_READ_WRITE */

/* str_yes_no() is defined */
/* #undef HAVE_STR_YES_NO */
...
/* #undef HAVE_TOPOLOGY_NUM_CORES_PER_PACKAGE */
...
/* #undef HAVE_WW_MUTEX_TRYLOCK_CONTEXT_ARG */
...
#define HAVE___SG_ALLOC_TABLE_FROM_PAGES_9ARGS 1
...
#define PACKAGE_STRING "amdgpu-dkms 6.14.14"
...
#define PACKAGE_VERSION "6.14.14"
